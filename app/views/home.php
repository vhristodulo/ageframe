...
<head>
    ...
    <!-- Custom CSS -->
    <link href="pub/css/grayscale.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="pub/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">AgeFrame</h1>
                        <p class="intro-text">Simple and fast MVC framework for PHP application.<br>Written in procedural style PHP.</p>
    ...
    <script src="pub/js/grayscale.js"></script>
